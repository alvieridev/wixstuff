...
const populateLeaderBoardTable = async (gender) =>{
	...
	// const leaderboardata = await formatLeaderBoardRowsAndColumns()
	$w('#leaderboardTable').columns = formattedColumns
	$w('#leaderboardTable').rows = formattedRows
